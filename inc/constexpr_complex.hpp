...
struct complex {
     ...
     * @param other _Complex number to convert from
     */
    constexpr complex(_Complex double other) : real_(__real__ other), imag_(__imag__ other) {}

    /**
     * @brief Constructor from _Complex float
     * @param other _Complex float number to convert from
     */
    constexpr complex(_Complex float other) : real_(static_cast<T>(__real__ other)), imag_(static_cast<T>(__imag__ other)) {}
