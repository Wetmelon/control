...
struct PIDController {
    ...
    constexpr PIDController(const design::PIDResult<T>& result) : Kp(result.Kp), Ki(result.Ki), Kd(result.Kd), Ts(result.Ts), u_min(result.u_min), u_max(result.u_max), i_min(result.i_min), i_max(result.i_max), Kbc(result.Kbc) {}
