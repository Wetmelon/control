...
TEST_SUITE("constexpr_math") {
    TEST_CASE("wet::sqrt matches std::sqrt") {
        ...
        // Test float
        CHECK(wet::sqrt(2.0f) == doctest::Approx(std::sqrt(2.0f)));
        CHECK(wet::sqrt(0.5f) == doctest::Approx(std::sqrt(0.5f)));
    }
    ...
    TEST_CASE("wet::csqrt matches std::sqrt for complex") {
        ...
        // Real positive
        CHECK(wet::csqrt(Complex(4.0, 0.0)).real() == doctest::Approx(std::sqrt(Complex(4.0, 0.0)).real()));
        CHECK(wet::csqrt(Complex(4.0, 0.0)).imag() == doctest::Approx(std::sqrt(Complex(4.0, 0.0)).imag()));
        ...
        // Pure imaginary
        CHECK(wet::csqrt(Complex(0.0, 4.0)).real() == doctest::Approx(std::sqrt(Complex(0.0, 4.0)).real()));
        CHECK(wet::csqrt(Complex(0.0, 4.0)).imag() == doctest::Approx(std::sqrt(Complex(0.0, 4.0)).imag()));

        // General complex
        CHECK(wet::csqrt(Complex(3.0, 4.0)).real() == doctest::Approx(std::sqrt(Complex(3.0, 4.0)).real()));
        CHECK(wet::csqrt(Complex(3.0, 4.0)).imag() == doctest::Approx(std::sqrt(Complex(3.0, 4.0)).imag()));
    ...
    TEST_CASE("constexpr verification") {
        ...
        constexpr auto   csqrt_val = wet::csqrt(std::complex<double>(4.0, 0.0));
