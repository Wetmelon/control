...
TEST_CASE("StateSpace Negative Feedback") {
    ...
    StateSpace<1, 1, 1, 1, 1> controller{
        .A = {{0.0}},
        .B = {{1.0}},
        .C = {{2.0}},
        .D = {{0.0}},
...
TEST_CASE("StateSpace Constexpr") {
    constexpr StateSpace<1, 1, 1, 1, 1> sys1{
        .A = {{-1.0}},
        .B = {{1.0}},
        .C = {{1.0}},
        .D = {{0.0}},
    ...
    constexpr StateSpace<1, 1, 1, 1, 1> sys2{
        .A = {{-2.0}},
        .B = {{1.0}},
        .C = {{1.0}},
        .D = {{0.0}},
